...
/**
 * Path logic here is kind of funny, it is where we end up, not where we went through. This means if
 * we see an AB inner Node to get there we went through the AB outer Node.
 */
