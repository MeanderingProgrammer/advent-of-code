...
class Store:
    ...
    def process(self, program):
        self.v1.set(program, program.io.get_input())
...
class Program:
    ...
    def __init__(self, memory, io, debug=False):
        self.memory, self.io, self.debug = memory, io, debug
        self.pointer, self.base = 0, 0
